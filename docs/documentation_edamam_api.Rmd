...
The raw data have been saved in multiple files, according to the diets. The files for this datacollection are: 'keto_raw_data.json', 'dash_raw_data.json', 'vegan_raw_data.json', 'paleo_raw_data.json', and 'mediterranean_raw_data.json'.
...
New Popular Diet Trends in 2022. (z.d.). Consulted on October 14th 2022, from https://planketogenic.pro/en/blog/most-popular-diets
