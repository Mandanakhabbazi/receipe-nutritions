...
For the raw data, 34,898 instances were collected. The raw data was stored in a .json output for further processing. 
...
![Example of the error when scaling data collection.](fig/figure3.jpeg)
