...
For the raw data, 7,563 instances were collected. The raw data is stored in a .json output for further processing. Table 3 contains the descriptive statistics of the five diets.
